...
function MyProfit() {
  ...
  if (!finance)
    return <div className="text-white text-xl font-medium p-20 text-center">Loading Finance Data...</div>
...
`}
  ...
  bg-[length:400%_400%] animate-[gradientMove_15s_ease_infinite] p-10">
    ...
    rounded-3xl p-10 shadow-2xl border border-cyan-900/40">
          ...
          border border-cyan-900/30 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-cyan-500/20">
            ...
            <div className="relative overflow-hidden group p-6 bg-[#1e293b] rounded-2xl 
          border border-emerald-900/30 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-emerald-500/20">
            ...
            <div className="relative overflow-hidden group p-6 bg-[#1e293b] rounded-2xl 
          border border-amber-900/30 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-amber-500/20">
            ...
            <div className="relative overflow-hidden group p-6 bg-[#1e293b] rounded-2xl 
          border border-rose-900/30 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-rose-500/20">
        ...
        rounded-3xl flex justify-between items-center border border-cyan-900/40 shadow-xl transition-all duration-500">
          ...
          {/* Calculator Section */}
          <div className="mt-16 bg-[#1e293b]/50 rounded-3xl p-8 border border-white/5">
            ...
            <div className="grid grid-cols-4 gap-4 mb-8">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#0f172a] border border-cyan-900/50 rounded-xl px-3 py-2 text-white focus:border-cyan-400 outline-none"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#0f172a] border border-emerald-900/50 rounded-xl px-3 py-2 text-white focus:border-emerald-400 outline-none"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#0f172a] border border-amber-900/50 rounded-xl px-3 py-2 text-white focus:border-amber-400 outline-none"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#0f172a] border border-rose-900/50 rounded-xl px-3 py-2 text-white focus:border-rose-400 outline-none"
                />
              </div>
            </div>
